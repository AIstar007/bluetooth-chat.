...
- Make sure to serve over HTTPS
  ...
  <p><strong> Use the browser's install prompt to save as an app (as shown in below image is the install icon in the browser to install the web app)</strong></p>
  <img
